...
public class Product {
	...
	@ApiModelProperty(name = "ProductName", value = "Hold the min 3 character product name", required = true)
	@NotEmpty(message = "Product Name cannot be left blank or null")
	@Size(min = 3, max = 15, message = "Invalid Product Name")
	private String productName;
	@ApiModelProperty(name = "Cost of the product", value = "Accepts product which has cost greater than 1000")
	@Min(value = 1000, message = "Cost cannot be less than 1000")
	private int productCost;
	@ApiModelProperty(name = "Rating of the product", value = "Holds rating of the product and should not be greater than 5 and cannot be less than 0")
	@Min(value = 1 , message = "Product cannot be rated less than 1")
	@Max(value = 5, message = "Product cannot be rated as more than 5")
	private int rating;
	@ApiModelProperty(name = "Category of the product", value = "Hold the min 6 character and max of 10 character product category")
